...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    do{
        if(empty($adoptarea_decizie)||empty ($proces) || empty ( $finalizarea) ){
            $errorMessage = "All the fields are required";
            break;
        }
       
        //add a new book to DB
        $sql = "INSERT INTO  sistem_decizional (adoptarea_decizie,proces,finalizarea)
        VALUES ('$adoptarea_decizie','$proces',' $finalizarea')";
...
<div class="home-btn">
    <a href="../menu1/sistem_decizonal.php">Gradul Critic </a>
</div>
...
?>
        <form method="post">
            ...
            <div class="row mb-3">
<label class="col-sm-3 col-form-label ">Adoptarea deciziei</label>
<div class="col-sm-6">
...
<div class="col-sm-6">
    <input type="text" class="form-control" name="proces" value="<?php echo $proces; ?>">
            ...
            <div class="row mb-3">
<label class="col-sm-3 col-form-label ">Finalizarea</label>
<div class="col-sm-6">
    <input type="text" class="form-control" name="finalizarea" value="<?php echo $finalizarea; ?>">
</div>
            </div>
...
<div class="col-sm-3 d-grid">
    <a style="color:lightslategray;background-color:white;" class="btn btn-outline-primary" href="../menu1/sistem_decizional.php" role="button">Cancel</a>
</div>
            </div>
        </form>
    </div>
