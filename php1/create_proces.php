...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    do{
        ...
        $sql = "INSERT INTO proces_decizie(factor,elemente,situatii, etape)
        VALUES ('$factor','$elemente',' $situatii',' $etape')";
...
<div class="home-btn">
    <a href="../menu1/proces_decizie.php">Procesul decizional </a>
</div>
